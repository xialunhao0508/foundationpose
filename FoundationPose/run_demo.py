...
if __name__ == '__main__':
    ...
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/haoliyou/mesh/changfangti.obj')
    # parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/screw/mesh/Screw.obj')
    parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/screw/mesh/Screw.obj')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/mustard0')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/kinect_driller_seq')
    # parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/haoliyou')
    parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/screw')
